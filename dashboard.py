...
# ── Page Config ───────────────────────────────────────────────
st.set_page_config(
    page_title="Dashboard Penjualan & Pembelian",
    page_icon="📊",
    layout="wide"
)
...
min_date = min(df_penjualan["Tanggal"].min(), df_pembelian["Tanggal"].min())
max_date = max(df_penjualan["Tanggal"].max(), df_pembelian["Tanggal"].max())
...
# ── Header ────────────────────────────────────────────────────
st.title("📊 Dashboard Penjualan & Pembelian")
st.caption(f"Periode: {start_date.date()} — {end_date.date()}")

# ── Tabs ──────────────────────────────────────────────────────
tab1, tab2 = st.tabs(["📊 E-Penjualan", "🛒 E-Pembelian"])
...
st.divider()
st.caption("© Dashboard Penjualan & Pembelian 2026")